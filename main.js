...
/* Automatic Image Fallback Handler for GitHub Pages */
    ...
    img.addEventListener('error', function handleImageError() {
      ...
      if (fallback && this.src !== fallback) {
        ...
        if (src.includes('assets/images/')) {
          this.src = src.replace('assets/images/', 'assets/');
        } else {
          this.src = 'https://images.unsplash.com/photo-1554118811-1e0d58224f24?auto=format&fit=crop&w=1200&q=80';
        }
      }
    }, { once: true });
  });
